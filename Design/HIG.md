...
- 텍스트만 보여주어야한다면 리스트/테이블을 사용할 것
- 필요한 경우에는 커스텀 인터랙션을 연결해 줄 것
- 항목의 삽입, 삭제, 재정렬 등을 해야 할 때에는 알맞는 피드백을 줄것



# Search
검색, 지우기 버튼, 플레이스홀더 등이 포함된 텍스트 입력 프레임
검색, 필터 등의 키워드를 입력할 때 사용

Baisc Rules
- 검색어를 안내하는 힌트(place holder)를 제공
- 검색을 시작할 타이밍을 고려할 것 (검색 버튼을 탭했을때, 혹은 매번 검색어를 입력받을 때)
